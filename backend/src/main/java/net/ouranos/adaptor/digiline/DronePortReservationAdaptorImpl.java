...
/**
 * DronePortReservationAdaptor実装クラス例。
 */
@Slf4j
@Component("DronePortReservationAdaptor")
public class DronePortReservationAdaptorImpl implements Adaptor<Object>{
    ...
    */
    ...
    public ResponseEntity<Object> sendGet(String targetDataModel, UUID tracking, String queryParam, String token) {
        ...
        if(queryParam == null) {
            String url = baseUrl + "/dronePortReservation";
