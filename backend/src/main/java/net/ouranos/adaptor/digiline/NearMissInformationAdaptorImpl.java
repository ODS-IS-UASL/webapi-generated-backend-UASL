...
/**
 * NearMissInformationAdaptor実装クラス例。
 */
@Slf4j
@Component("NearMissInformationAdaptor")
public class NearMissInformationAdaptorImpl implements Adaptor<Object>{
    ...
    */
     ...
     */
     ...
     @Override
     public ResponseEntity<Object> sendPut(Object targetDataModel, UUID tracking, String queryParam, String token) {
         return null;
     }
     ...
     */
    @Override
    public ResponseEntity<Object> sendPost(Object dataModelNearMissInformationRequest, UUID tracking, String queryParam, String token) {
        log.info("Send POST to XXX service. Tracking = {}", tracking);
        ResponseEntity<Object> result;
        if(queryParam == null) {
            String url = baseUrl + "/nearMissInformation";
            ...
            .body(dataModelNearMissInformationRequest)
            .retrieve()
